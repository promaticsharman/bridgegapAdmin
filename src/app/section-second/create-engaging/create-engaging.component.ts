...
@Component({
  ...
  templateUrl: './create-engaging.component.html',
  styleUrls: ['./create-engaging.component.css']
})
export class CreateEngagingComponent implements OnInit {
  image
  imgUrl
  engagingData: any = {
    heading:"",
  ...
  add(){
    ...
    this.service.saveEngagingAndEfficients(formData).subscribe(data => {
